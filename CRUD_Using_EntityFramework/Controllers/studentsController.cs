...
namespace CRUD_Using_EntityFramework.Controllers
{
    public class studentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RollNumber,Name,Email,DOB")] student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RollNumber,Name,Email,DOB")] student student)
        {
            if (ModelState.IsValid)
            {
